                    ...
                    <div class="card-body">
                        <div class="form-group mb-4">
                            ...
                            <input type="number" class="form-control @error('nik') is-invalid @enderror" id="nik"
                                name="nik" placeholder="Masukkan NIK" inputmode="numeric" value="{{ old('nik') }}">
                            @error('nik')
                ...
                'value' => 'female',
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea name="address" id="address" cols="10" rows="3"
                                class="form-control @error('address') is-invalid @enderror" placeholder="Masukkan Alamat">{{ old('address') }}</textarea>
                            @error('address')
                                <span class="invalid-feedback mt-2">
                                    {{ $message }}
                                </span>
